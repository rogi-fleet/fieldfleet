...
class CustomerMessagesTab extends StatefulWidget {
  ...
  const CustomerMessagesTab({super.key, required this.customer});

  @override
  State<CustomerMessagesTab> createState() => _CustomerMessagesTabState();
}
...
class _CustomerMessagesTabState extends State<CustomerMessagesTab> {
  ...
  Widget _buildList(String workspaceId, String userId,
    ...
    return ScopedConversationListPane(
      ...
      scope: 'customer',
      scopeReferenceId: widget.customer.id,
  ...
  Widget _buildForm(String workspaceId, String userId, String userName,
    ...
    return ScopedNewConversationForm(
      key: const ValueKey('customer-new-conv'),
      workspaceId: workspaceId,
      currentUserId: userId,
      currentUserName: userName,
      scope: 'customer',
      scopeReferenceId: widget.customer.id,
      scopeReferenceName: widget.customer.displayName,
      compact: compact,
      onClose: () {
        setState(() {
          _isCreatingNew = false;
